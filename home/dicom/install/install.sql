...
create table conf (conf_id int(10) UNSIGNED UNIQUE not null AUTO_INCREMENT,
				      ...
				      active int(1) not null default 1,
 				      primary key (conf_id));
create table proc (proc_id int(10) UNSIGNED UNIQUE not null AUTO_INCREMENT,
					  ...
					  active int(1) not null default 1,
				      primary key (proc_id));
create table send (send_id int(10) UNSIGNED UNIQUE not null AUTO_INCREMENT,
					  conf_id int(10) UNSIGNED,
					  ...
					  send_port int(5) not null default 104,
					  send_ip varchar(32) not null default 'localhost',
