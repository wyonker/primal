...
create table conf_proc (conf_proc_id int(10) UNSIGNED UNIQUE not null AUTO_INCREMENT,
					  ...
					  proc_tag varchar(16) not null default '0010,0010',
...
create table rec (id bigint(10) UNSIGNED UNIQUE not null AUTO_INCREMENT,
				...
				accn varchar(38) not null default 0,
				org varchar(5) not null default "UNK",
				...
				INDEX accn (accn));
grant all privileges on mirth_primal.* to 'primal'@'localhost' identified by 'ThisIsMirth1!' with grant option;