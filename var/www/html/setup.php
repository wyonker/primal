...
EOT;
Display_Header2();
echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/edit.php?zz=1">Edit</a>';
echo '<br><br><br>';
echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/add_user.php">Add User</a></br>';
echo '<br><br>';
if ($_GET['e'] == 1)
{
	...
	foreach($users as $u)
	{
		...
		{
			echo '<tr>';
			echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/update_user.php?e=' . $users[$lc1]['loginid'] . '">' . $users[$lc1]['loginid'] . '</a></td>';
