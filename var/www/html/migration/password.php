...
if($_SESSION['callerid']!= "/migration/update_user.php" && $_SESSION['callerid']!= "/migration/login2.php" && $_SESSION['callerid']!= "/migration/options.php")
{
...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	if($_SESSION['callerid']!= "/migration/update_user.php")
	{
    ...
    if ($_SESSION['perror'] == 0)
    {
		...
		} elseif ($_SESSION['callerid']== "/migration/query.php") {
			header ("location: /migration/query.php");
		} else {
			header ("location: login.php");
		}
    } else {
