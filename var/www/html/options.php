...
Display_Header2();
echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/password.php">Reset Password</a><br><br>';
if($num_rows != 1)
{
    ...
    while ($lc4 < count($ucolumns)) {
        if ( $ucolumns[$lc4]["order"] == $lc3 ) {
            ...
            if ( $ucolumns[$lc4]["visible"] == 1) {
                ...
                echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/options.php?e=' . $_session['loginid'] . '&c=' . $ucolumns[$lc4]["dorder"] . '&h=0' . '">Unhide</a></td>';
            } else {
                echo '<td>' . $ucolumns[$lc4]["name"] . '</td>';
                echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/options.php?e=' . $_session['loginid'] . '&c=' . $ucolumns[$lc4]["dorder"] . '&h=1' . '">Hide</a></td>';
            }
            if ($lc3 > 1) {
                echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/options.php?e=' . $_session['loginid'] . '&c=' . $ucolumns[$lc4]["dorder"] . '&o=u">Up</a></td>';
            } else {
                echo '<td></td>';
            }
            if ($lc3 < count($ucolumns)) {
                echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/options.php?e=' . $_session['loginid'] . '&c=' . $ucolumns[$lc4]["dorder"] . '&o=d">Down</a></td>';
            } else {
                echo '<td></td>';
            }
            echo '</tr>';
