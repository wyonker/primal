...
$intLC1=0;
while($intLC1 < sizeof($_SESSION['PRINUM'])) {
	echo '<tr><td>' . $_SESSION['PRINUM'][$intLC1] . '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/edit.php?v=';
...
if($intNumRec < 10) {
	...
	if(isset($_GET['v'])) {
		echo '/primal/edit.php?v=' . $_GET['v'] . '&ar=' . $intLC1 . '">Add Receiver</a><br>';
	} else {
		echo '/primal/edit.php?ar=' . $intLC1 . '">Add Receiver</a><br>';
	}
}
echo '<br><br>';
if(isset($_GET['v'])) {
	...
	echo '<a href="http://' . $_SERVER['HTTP_HOST'];
	echo '/primal/edit.php?v=' . $_GET['v'] . '&dr=' . $_GET['v'] . '">Delete</a></th></tr>';
	...
	while(isset($_SESSION['PRIDESTHIP'][$_GET['v']][$intLC2])) {
		...
		echo '<a href="http://' . $_SERVER['HTTP_HOST'];
		echo '/primal/edit.php?v=' . $_GET['v'] . '&dd=' . $intLC2 . '">Delete</a></th></tr>';
	...
	while(isset($_SESSION['PRIQRHIP'][$_GET['v']][$intLC3])) {
		...
		echo '<a href="http://' . $_SERVER['HTTP_HOST'];
		echo '/primal/edit.php?v=' . $_GET['v'] . '&dq=' . $intLC3 . '">Delete</a></th></tr>';
	...
	if($intLC2 < 10) {
		echo '<a href="http://' . $_SERVER['HTTP_HOST'];
		echo '/primal/edit.php?v=' . $_GET['v'] . '&ad=' . $intLC2 . '">Add Destination</a><br>';
	}
	if($intLC3 < 10) {
		echo '<a href="http://' . $_SERVER['HTTP_HOST'];
		echo '/primal/edit.php?v=' . $_GET['v'] . '&aq=' . $intLC3 . '">Add Q/R Source</a><br>';
	}
	echo '<br>';
	echo '<table border="1">';
	...
	while(isset($_SESSION['PRITAGNAME'][$_GET['v']][$intLC2])) {
		...
		echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/edit.php?v=' . $_GET['v'];
	...
	echo '<br>';
	echo '<a href="http://' . $_SERVER['HTTP_HOST'];
	echo '/primal/edit.php?v=' . $_GET['v'] . '&at=' . $intLC2 . '">Add Tag Modification</a><br>';
	echo '<br>';
	echo '<table border="1">';
	...
	echo '<br>';
	echo '<a href="http://' . $_SERVER['HTTP_HOST'];
	echo '/primal/edit.php?v=' . $_GET['v'] . '&aqt=' . $intLC2 . '">Add Q/R Tag Search Parameter</a><br>';
}
...
echo '<a href="http://' . $_SERVER['HTTP_HOST'];
if(isset($_GET['v'])) {
	echo '/primal/edit.php?v=' . $_GET['v'] . '&save=1">Save Changes</a><br>';
} else {
	echo '/primal/edit.php?save=1">Save Changes</a><br>';
}
echo '   </form><br>';
if(isset($strOutput)) {
	echo $strOutput . "<br>";
