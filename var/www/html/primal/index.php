...
{
	echo '<div id="setup"><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/setup.php">Setup</a></div>';
}
...
if($count_rows > $_SESSION['page_size'] && $_SESSION['page_size'] != 0)
{
	...
	$lc1=0;
	echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=' . $_GET["c"] . '&o=' . $_GET["o"] . '&p=' . $lc1 . '">First</a> ';
	if ($_GET["p"] > 0)
	{
		echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=' . $_GET["c"] . '&o=' . $_GET["o"] . '&p=' . ($_GET["p"]-1) . '"> << </a> ';
	}
	while($lc1 <= $count_pages)
	{
		if($lc1 >= $start_page && $lc1 <= $end_page)
		{
			if($lc1 == $_GET["p"])
			{
				...
				echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=' . $_GET["c"] . '&o=' . $_GET["o"] . '&p=' . $lc1 . '">' . ($lc1+1) . '</a> ';
			}
		}
		$lc1++;
	}
	...
	echo '<a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=' . $_GET["c"] . '&o=' . $_GET["o"] . '&p=' . ($total_pages) . '">Last</a> ';
}
if(isset($err_msg))
...
case 1:
	if($ucolumns[0]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=0&o=1&p=' . $_GET["p"] . '">Start Receive</a><br/>';
			...
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=0&o=0&p=' . $_GET["p"] . '">Start Receive</a><br/>';
			if(isset($_SESSION['input_startdt']))
			{
				echo '<input type="date" name="input_startdt" value="' . $_SESSION['input_startdt'] . '"/></br>';
			} else {
...
case 2:
	if($ucolumns[1]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=1&o=1&p=' . $_GET["p"] . '">Patient Name</a><br/>';
			...
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=1&o=0&p=' . $_GET["p"] . '">Patient Name</a><br/>';
			if(isset($_SESSION['input_pname']))
			{
				echo '<input type="text" name="input_pname" value="' . $_SESSION['input_pname'] . '"/></th>';
			} else {
...
case 3:
	if($ucolumns[2]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=2&o=1&p=' . $_GET["p"] . '">Patient ID</a></br>';
			...
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=2&o=0&p=' . $_GET["p"] . '">Patient ID</a></br>';
			if(isset($_SESSION['input_pid'])) {
				echo '<input type="text" name="input_pid" />' . $_SESSION["input_pid"] . '</th>';
			} else {
				echo '<input type="text" name="input_pid" /></th>';
...
case 4:
	if($ucolumns[3]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=3&o=1&p=' . $_GET["p"] . '">Accession #</a></br>';
			...
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=3&o=0&p=' . $_GET["p"] . '">Accession #</a></br>';
			if(isset($_SESSION['input_accn']))
			{
				echo '<input type="text" name="input_accn" value="' . $_SESSION['input_accn'] . '"/></th>';
			} else {
...
case 5:
	if($ucolumns[4]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=4&o=1&p=' . $_GET["p"] . '">DOB</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=4&o=0&p=' . $_GET["p"] . '">DOB</a></th>';
		}
	}
break;
case 6:
	if($ucolumns[5]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=5&o=1&p=' . $_GET["p"] . '">MOD</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=5&o=0&p=' . $_GET["p"] . '">MOD</a></th>';
		}
	}
break;
case 7:
	if($ucolumns[6]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=6&o=1&p=' . $_GET["p"] . '">Study Date</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=6&o=0&p=' . $_GET["p"] . '">Study Date</a></th>';
		}
	}
break;
case 8:
	if($ucolumns[7]["visible"] == 0) {
		...
		{
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=7&o=1&p=' . $_GET["p"] . '">End Receive</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=7&o=0&p=' . $_GET["p"] . '">End Receive</a></th>';
		}
	}
break;
case 9:
	if($ucolumns[8]["visible"] == 0) {
		if ($sort_column == 8 && $intSortOrder == 0) {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=8&o=1&p=' . $_GET["p"] . '">#<br>images<br>rec</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=8&o=0&p=' . $_GET["p"] . '">#<br>images<br>rec</a></th>';
		}
	}
break;
case 10:
...
case 13:
	if($ucolumns[12]["visible"] == 0) {
		if ($sort_column == 9 && $intSortOrder == 0) {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=9&o=1&p=' . $_GET["p"] . '">Start Send Date</a></th>';
		} else {
			echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=9&o=0&p=' . $_GET["p"] . '">Start Send Date</a></th>';
		}
	}
break;
case 14:
...
case 17:
	if($ucolumns[16]["visible"] == 0) {
		...
		echo '<th><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/index.php?c=10&o=' . $bolSortOrder . '&p=' . $_GET["p"] . '">Sender<br>AET</a></th>';
	}
break;
case 18:
...
case 2:
	if($ucolumns[1]["visible"] == 0) {
		echo '<td><a href="http://' . $_SERVER['HTTP_HOST'] . '/primal/resend.php?p=' . $studies[$lc1]["puid"] . '"> ' . $studies[$lc1]["pname"] . '</a></td>';
	}
break;
case 3:
	if($ucolumns[2]["visible"] == 0) {
