...
if($_GET['action'] == 'Restart') {
	//display messages in a popup box immediatly before each action.
	echo '<div id="restartModal" class="modal"><div class="modal-content"><span class="close" onclick="document.getElementById(\'restartModal\').style.display=\'none\'">&times;</span><p id="restartMessage">';
	echo 'alert("Stopping PRIMAL services...")';
	exec("sudo /home/dicom/startup.bash stop ALL");
	sleep(15);
	echo 'alert("Starting PRIMAL services...")';
	exec("sudo /home/dicom/startup.bash start ALL");
	sleep(15);
	echo '</p></div></div>';
	echo '<script>document.getElementById("restartModal").style.display="block";</script>';
	echo 'function closeModal() {document.getElementById("restartModal").style.display="none";}';
	echo 'setTimeout(closeModal, 30000);';
	echo '<script>setTimeout(closeModal, 30000);</script>';
	echo '<script>window.onload = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onbeforeunload = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onunload = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onblur = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onfocus = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onresize = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onscroll = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onclick = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondblclick = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onkeydown = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onkeyup = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onkeypress = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.oncontextmenu = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onwheel = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ontouchstart = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ontouchend = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ontouchmove = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ontouchcancel = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpointerdown = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpointerup = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpointermove = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpointercancel = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onselectstart = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondragstart = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondragend = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondragenter = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondragover = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondragleave = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ondrop = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onhashchange = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onlanguagechange = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onmessage = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onoffline = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.ononline = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpagehide = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpageshow = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onpopstate = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onresize = function() {setTimeout(closeModal, 30000);}</script>';
	echo '<script>window.onscroll = function() {setTimeout(closeModal, 30000);}</script>';
	echo '</script>';
	header("Location: setup.php");
